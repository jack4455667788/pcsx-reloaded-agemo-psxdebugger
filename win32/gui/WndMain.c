			...
			switch (LOWORD(wParam)) {
				...
				case IDC_PASTE:
					...
					if (copymcd == 1) {
						...
						SaveMcd(str, Mcd1Data, (u32)((i+1) * 128), 128);
						memcpy(Mcd1Data + (i+1) * 1024 * 8, Mcd2Data + (copy+1) * 1024 * 8, 1024 * 8);
						SaveMcd(str, Mcd1Data, (u32)((i+1) * 1024 * 8), 1024 * 8);
					} else { // 2
						...
						SaveMcd(str, Mcd2Data, (u32)((i+1) * 128), 128);
						memcpy(Mcd2Data + (i+1) * 1024 * 8, Mcd1Data + (copy+1) * 1024 * 8, 1024 * 8);
						SaveMcd(str, Mcd2Data, (u32)((i+1) * 1024 * 8), 1024 * 8);
					}
				...
				case IDC_DELETE1:
				{
					...
					*ptr = xor;
					...
					SaveMcd(str, data, (u32)(i * 128), 128);
					UpdateMcdDlg();
				}
...
void CreateMainMenu() {
	...
	//ADDMENUITEM(0, _("Debug &CD"), DEBUG_DIALOG);
